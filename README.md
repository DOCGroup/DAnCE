...
```git checkout -b <topic>_DAnCE-1_3_4 DAnCE-1_3_4```
...
* Switch to `<topic>_DAnCE-1_3_4`. For example:
```git checkout <topic>_DAnCE-1_3_4```
* Cherry-pick your commit on `<topic>_master` onto `<topic>_DAnCE-1_3_4`. For example:
```git cherry-pick <commit_id>```
* Test `<topic>_DAnCE-1_3_4` for correctness, modify as necessary
...
$ git checkout DAnCE-1_3_4
$ git pull origin DAnCE-1_3_4
```
...
```
$ git checkout topic_DAnCE-1_3_4
$ git rebase DAnCE-1_3_4
```
...
$ git checkout DAnCE-1_3_4
$ git pull upstream DAnCE-1_3_4
$ git push origin DAnCE-1_3_4
```
